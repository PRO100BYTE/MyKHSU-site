...
const Roadmap = () => {
  ...
  const roadmapData = [
    ...
    {
      version: "v2.2",
      title: "Исправления и доработки",
      status: "in-progress",
      items: [
        "Запуск службы уведомлений для отправки уведомлений о новых новостях и начале/конце пары",
        "Реализация возможности добавления заметок/домашнего задания к паре",
        "Улучшение производительности и стабильности приложения",
        "Оптимизация кода и исправление выявленных багов"
      ]
    },
    {
      version: "v2.1",
  ...
  const studentIdeas = [
    ...
    "Добавление чата с куратором группы",
    "Возможность указывать заметки/домашнее задание к паре (Модуль для заметок и домашних заданий)",
    "Расписание столовой (ну, или Пятерочки / сосисочной) :)",
    "Интеграция с Образовательным порталом ХГУ для вывода успеваемости студента",
    "Система оповещения о свободных аудиториях",
    "Интеграция с Образовательным порталом ХГУ (Moodle) для отображения доступных тестов и быстрого перехода к курсам",
  ...
  return (
    ...
    >
      ...
      <section className="ideas-section">
        <div className="container">
          <div className="section-title">
            <h2>Идеи от студентов и преподавателей</h2>
